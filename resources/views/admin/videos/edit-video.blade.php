...
@section('content-header')
    <h4 class="c-grey-900 mT-10 mB-30"> {{ tr('edit_video') }}</h4>
@endsection

@section('breadcrumb')
    <li class="list-inline-item"><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i>{{tr('home')}}</a></li>
    <li class="list-inline-item"><a href="{{request()->headers->get('referer')}}"><i class="fa fa-video-camera"></i>{{tr('videos')}}</a></li>
    <li class="list-inline-item active"> {{tr('edit_video')}}</li>
@endsection
                                ...
                                <div class="tab-pane active" role="tabpanel" id="step1">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required class="form-control" id="title" name="title"
                                                       placeholder="{{tr('title')}}" value="{{$video->title}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="publish_time"
                                                       ...
                                                       value="{{$video->publish_time}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label>{{tr('duration')}} *
                                                    : </label><!-- <small> {{tr('duration_note')}}</small> -->
                                        ...
                                        <input type="hidden" name="is_banner" value="{{$video->is_banner}}"
                                               id="is_banner">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea style="overflow:auto;resize:none" class="form-control"
                                                          ...
                                                          name="reviews">{{$video->reviews}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                            ...
                                            <!-- <textarea  style="overflow:auto;resize:none" class="form-control" rows="4" cols="50" id="ckeditor" name="details">{{$video->details}}</textarea> -->
                                                ...
                                                <textarea id="ckeditor" name="details"
                                                          class="form-control">{{$video->details}}</textarea>
                                        ...
                                        @foreach($categories as $category)
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                                                <a onclick="saveCategory({{$category->id}}, {{REQUEST_STEP_2}})"
                                                   class="{{$css}} category-item text-center">
                                                    <div style="background-image: url({{$category->picture}})"
                                                         class="category-img bg-img"></div>
                                                    <h3 class="category-tit"><i id="{{$category->id}}_i"
                                                                                class="fa fa-check-circle"
                                                                                style="display:none;color:#51af33"
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li class="pull-right">
                                            <button type="button" class="btn btn-primary next-step"
                                                    id="{{REQUEST_STEP_2}}">{{tr('next')}}</button>
                                        </li>
                                        <div class="clearfix"></div>
                                    </ul>
                                </div>
                                <div class="tab-pane" role="tabpanel" id="step3">
                                    ...
                                    <div id="sub_category">
                                        @foreach($subCategories as $subCategory)
                                            ...
                                            ?>
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                                                <a onclick="saveSubCategory({{$subCategory->id}}, {{REQUEST_STEP_3}})"
                                                   class="{{$subcss}} category-item text-center">
                                                    <div style="background-image: url({{$subCategory->picture}})"
                                                         class="category-img bg-img"></div>
                                                    <h3 class="category-tit"><i id="{{$subCategory->id}}_sub_i"
                                                                                class="fa fa-check-circle"
                                                                                style="display:none;color:#51af33"
                                                                                aria-hidden="true"></i> {{$subCategory->name}}
                                                    </h3>
                                                </a>
                                            </div>
                                        @endforeach
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li class="pull-right" style="display: none">
                                            <button id="{{REQUEST_STEP_3}}" type="button"
                                                    class="btn btn-primary btn-info-full next-step">{{tr('next')}}</button>
                                        </li>
                                        <div class="clearfix"></div>
                                    </ul>
                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="genre_id">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="genre" name="genre_id" class=" form-control select2"
                                                            @if(!$video->is_series) disabled @endif>
                                                        @if($video->genre_id)
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="banner_image"
                                                               class="">{{tr('banner_image')}}</label>
                                                        <input type="file" id="banner_image" name="banner_image"
                                                               accept="image/png, image/jpeg"
                                                               placeholder="{{tr('banner_image')}}" style="display:none"
                                                               onchange="loadFile(this, 'banner_img')">
                                                        <div>
                                                            <img src="{{$video->banner_image ? $video->banner_image : asset('images/320x150.png')}}"
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <img src="{{($video->default_image) ? $video->default_image : asset('images/320x150.png')}}"
                                                             style="width:150px;height:75px;"
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <img src="{{isset($videoimages[0]->image) ? $videoimages[0]->image : asset('images/320x150.png')}}"
                                                             style="width:150px;height:75px;"
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <img src="{{isset($videoimages[1]->image) ? $videoimages[1]->image : asset('images/320x150.png')}}"
                                                             style="width:150px;height:75px;"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="compress">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <div>
                                                        <input type="radio" name="compress_video" class="minimal-red"
                                                               value="1"> <label>{{tr('yes')}}</label> &nbsp;&nbsp;
                                                        <input type="radio" name="compress_video" class="minimal-red"
                                                               value="0" checked> <label>{{tr('no')}}</label>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if(check_s3_configure())
                                                            ...
                                                            <label style="margin-top:10px">
                                                                <input type="radio" name="video_upload_type" value="1"
                                                                       @if($video->video_upload_type == 1) checked @endif>
                                                                {{tr('s3')}}
                                                            </label>
                                                        ...
                                                        <label style="margin-top:10px">
                                                            <input type="radio" name="video_upload_type" value="2"
                                                                   @if($video->video_upload_type == 2) checked @endif>
                                                            {{tr('direct')}}
                                                        </label>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="url" class="form-control" id="other_video"
                                                               ...
                                                               @if($video->video_type == 2 || $video->video_type == 3) value="{{$video->video}}" @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="url" class="form-control" id="other_trailer_video"
                                                               ...
                                                               placeholder="{{tr('trailer_video')}}"
                                                               @if($video->video_type == 2 || $video->video_type == 3) value="{{$video->trailer_video}}" @endif>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <label>{{tr('send_notification')}}</label>&nbsp;&nbsp;<input
                                                        type="checkbox" name="send_notification" value="1"/>
