<div class="form-group row">
    ...
    <div class="col-md-9">
        <div class="form-group">
            <input class="form-control" name="code" type="text" id="code" value="{{ $giftcard->code ?? ''}}" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <div class="form-group">
            <input class="form-control" name="price" type="number" id="price" value="{{ $giftcard->price ?? ''}}"
                   required>
