                        ...
                        <div class="table table-responsive">
                            ...
                            <table id="dataTable" class="table table-striped table-bordered" cellspacing="0"
                                ...
                                @foreach($payments as $i => $payment)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if($i == 0 && !$payment->is_cancelled && $payment->status == PAID_STATUS)
                                                <a data-toggle="modal"
                                                   data-target="#{{$payment->id}}_cancel_subscription"
                                                   class="pull-right btn btn-sm btn-danger">{{tr('cancel_subscription')}}</a>

                                            @elseif($i == 0 && $payment->is_cancelled && $payment->status == PAID_STATUS)

                                                <?php $enable_subscription_notes = tr('enable_subscription_notes'); ?>

                                                <a onclick="return confirm('{{$enable_subscription_notes}}')"
                                                   href="{{route('admin.enable.subscription', ['id'=>$payment->user_id])}}"
                                                   class="pull-right btn btn-sm btn-success">{{tr('enable_subscription')}}</a>
                                    ...
                                    <div class="modal fade error-popup" id="{{$payment->id}}_cancel_subscription"
                                         role="dialog">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <textarea rows="5" name="cancel_reason"
                                                                          id='cancel_reason'
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <button type="submit"
                                                                    class="btn btn-primary top">{{tr('submit')}}</button>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                                    ...
                                    <!-- <img alt="{{$subscription->title}}" src="{{$subscription->picture ?  $subscription->picture : asset('common/img/landing-9.png')}}" class="subscription-image" /> -->
                                        ...
                                        <div class="caption">
                                            ...
                                            <h3>
                                                <a href="{{route('admin.subscriptions.view' , $subscription->unique_id)}}"
