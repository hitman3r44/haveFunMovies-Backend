...
@section('breadcrumb')
    ...
    <li class="list-inline-item"><a href="{{route('admin.banner.videos')}}"><i class="fa fa-university"></i>{{tr('banner_videos')}}</a></li>
    <li class="list-inline-item active"><i class="fa fa-university"></i> {{tr('add_banner_videos')}}</li>
@endsection
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required class="form-control" id="title"
                                                           name="title" placeholder="{{tr('title')}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <label style="margin-top:10px" id="youtube">
                                                        <input required type="radio" name="video_type" class="flat-red"
                                                               value="2">
                                                        {{tr('youtube')}}
                                                    </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        @foreach(getVideoResolutions() as $resolution)
                                                            <input type="checkbox" name="video_resolutions[]"
                                            ...
                                            <div id="upload">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <label style="margin-top:10px">
                                                            <input type="radio" name="video_upload_type"
                                                                   class="flat-red" value="2" checked>
                                                            {{tr('direct')}}
                                                        </label>
                                            ...
                                            <div id="others">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="other_video"
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="other_trailer_video"
                                                               class="">{{tr('trailer_video')}}</label>
                                                        <input type="text" class="form-control" id="other_trailer_video"
