...
@section('content-header')
    <h4 class="c-grey-900 mT-10 mB-30"> {{ tr('redeem_payout') }}</h4>
@endsection

@section('breadcrumb')
    <li class="list-inline-item"><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i>{{tr('home')}}
        </a></li>
    <li class="list-inline-item"><a href="{{route('admin.moderators.redeems')}}"><i
                    class="fa fa-users"></i> {{tr('redeems')}}</a></li>
    <li class="list-inline-item active">{{tr('redeem_payout')}}</li>
@endsection
                                ...
                                @if(in_array($data->redeem_request_status ,[REDEEM_REQUEST_SENT , REDEEM_REQUEST_PROCESSING]))
                                    ...
                                    @if($data->moderator_details->email)
                                        ...
                                        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <input name="business"
                                                   value="{{$data->moderator_details ? $data->moderator_details->email : ''}}"
                                                   type="hidden">
                                            ...
                                            <input name="return"
                                                   value="{{route('admin.moderators.payout.response' , ['moderator_id' => $data->moderator_id , 'redeem_request_id' => $data->redeem_request_id , 'success' => true])}}"
                                                   type="hidden">

                                            <input name="cbt" value="Return to My Site" type="hidden">

                                            <input name="cancel_return"
                                                   value="{{route('admin.moderators.payout.response' , ['moderator_id' => $data->moderator_id , 'redeem_request_id' => $data->redeem_request_id , 'success' => false])}}"
                                                   type="hidden">
