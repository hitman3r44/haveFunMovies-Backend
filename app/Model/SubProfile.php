...
class SubProfile extends Model
{
    ...
    {
        return $this->hasMany('App\Model\UserHistory', 'user_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Model\Flag', 'sub_profile_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Model\ContinueWatchingVideo', 'sub_profile_id', 'id');
    }
