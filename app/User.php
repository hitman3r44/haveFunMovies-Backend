...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany('App\Model\SubProfile');
    }
    ...
    {
        return $this->hasMany('App\Model\UserLoggedDevice');
    }
    ...
    {
        return $this->hasMany('App\Model\Flag', 'user_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Model\PayPerView', 'user_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Model\ContinueWatchingVideo', 'user_id', 'id');
    }
