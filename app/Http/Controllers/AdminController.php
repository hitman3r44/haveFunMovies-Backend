...
use App\Model\UserLoggedDevice;
    ...
    public function gif_generator(Request $request)
    {
        ...
        if ($video) {
            ...
            $FFmpeg
                ->setImage('image2')
                ->setFrameRate(1)
                ->input(base_path('public') . "/uploads/images/video_{$request->video_id}_%03d.png")
                ->setAspectRatio("4:2")
                ->frameRate(30)
                ->output(base_path('public') . "/uploads/gifs/video_{$request->video_id}.gif")
                ->ready();
