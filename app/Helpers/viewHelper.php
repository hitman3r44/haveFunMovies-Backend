...
use App\Model\MobileRegister;

use App\Model\PageCounter;
...
function get_register_count() {
    ...
    $ios_count = MobileRegister::where('type' , 'ios')->count();

    $android_count = MobileRegister::where('type' , 'android')->count();

    $web_count = MobileRegister::where('type' , 'web')->count();
